...
import com.aventstack.extentreports.Status;
 ...
 public class AccountMovementStep {
     ...
     private void storeAmountToReceive() {
         ElementDataUtils.extractAndStore(accountScreenPageObject.pendingAmountLabel(), "dataUser", "secondUser", "amountToReceive");
     }
